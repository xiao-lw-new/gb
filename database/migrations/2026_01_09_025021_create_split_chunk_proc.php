...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $baseSql = <<<'SQL'
CREATE OR REPLACE PROCEDURE public.split_chunk(
    IN chunk regclass,
    IN split_at "any" DEFAULT NULL::unknown
)
 LANGUAGE c
AS '$libdir/timescaledb-%s', $$ts_split_chunk$$
SQL;
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS split_chunk");
    }
};
