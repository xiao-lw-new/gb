...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $baseSql = <<<'SQL'
CREATE OR REPLACE PROCEDURE public.remove_columnstore_policy(
    IN hypertable regclass,
    IN if_exists boolean DEFAULT false
)
 LANGUAGE c
AS '$libdir/timescaledb-%s', $$ts_policy_compression_remove$$
SQL;
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS remove_columnstore_policy");
    }
};
