...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // EventStartRelease signature/topic
        $signature = $this->buildEventSignature($abi, 'EventStartRelease');
        if (!$signature) {
            return;
        }
        ...
        DB::table('blockchain_contract_event')->updateOrInsert(
            [
                ...
                'event_name' => 'EventStartRelease',
            ],
            [
                'handler' => EventStartReleaseHandler::class,
                'topic' => $topic,
                'remark' => $signature,
                'status' => 1,
                'updated_at' => now(),
