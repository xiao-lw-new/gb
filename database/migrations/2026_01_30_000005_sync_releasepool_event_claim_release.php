...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // EventClaimRelease signature/topic
        $signature = $this->buildEventSignature($abi, 'EventClaimRelease');
        if (!$signature) {
            return;
        }
        ...
        DB::table('blockchain_contract_event')->updateOrInsert(
            [
                ...
                'event_name' => 'EventClaimRelease',
            ],
            [
                'handler' => EventClaimReleaseHandler::class,
                'topic' => $topic,
                'remark' => $signature,
                'status' => 1,
                'updated_at' => now(),
