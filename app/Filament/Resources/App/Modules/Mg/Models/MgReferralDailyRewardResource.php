...
use App\Filament\Resources\App\Modules\Mg\Models\MgReferralDailyRewardResource\Pages;
use App\Modules\Mg\Models\MgReferralDailyReward;
use Filament\Tables;
use Filament\Tables\Table;
use Filament\Tables\Columns\TextColumn;

class MgReferralDailyRewardResource extends BaseResource
{
    protected static ?string $model = MgReferralDailyReward::class;

    protected static ?string $navigationIcon = 'heroicon-o-users';
    protected static ?string $navigationGroup = '收益审计';
    protected static ?string $label = '推荐奖汇总';
    protected static ?string $pluralLabel = '推荐奖汇总';
    ...
    {
        return [
            'index' => Pages\ManageMgReferralDailyRewards::route('/'),
        ];
    }
